...
**
** Created: Tue 14. Jul 17:47:49 2015
...
static const char qt_meta_stringdata_MyQwtPlot[] = {
    "MyQwtPlot\0"
};
...
const QMetaObjectExtraData MyQwtPlot::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyQwtPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_MyQwtPlot,
      qt_meta_data_MyQwtPlot, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyQwtPlot::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyQwtPlot))
